...
public class Top10MutualFriendsTemp {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Job job = new Job(conf, "Top10MutualFriends Phase 1");
        job.setJarByClass(Top10MutualFriendsTemp.class);
        ...
        if (mapreduce) {
            ...
            @SuppressWarnings("deprecation")
            Job job1 = new Job(conf1, "Top10MutualFriends Phase 2");
            job1.setJarByClass(Top10MutualFriendsTemp.class);
